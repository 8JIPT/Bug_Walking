...
void Chaser::UpdateSteering(float deltaTime)
{
    ...
    {
        // Normal missile
        new Missile(GetGame(), mPosition, 150.0f, 5.0f, "../Assets/Sprites/Chaser/roc.png", Vector3(1.0f, 0.5f, 0.0f));
...
void Chaser::UpdateBattle(float deltaTime)
{
    ...
    {
        // Battle missile
        new Missile(GetGame(), mPosition, 250.0f, 5.0f, "../Assets/Sprites/Chaser/storm_shadow.png", Vector3(1.0f, 0.0f, 0.5f));
